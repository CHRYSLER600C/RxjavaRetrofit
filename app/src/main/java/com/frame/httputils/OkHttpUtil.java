...
public class OkHttpUtil {
    ...
    public <T> void doRequestImpl(String methodName, List<String> params, Map<String, Object> map, ProgressObserver<T> progressObserver) {
        Method method;
     ...
     */
    private static class HttpResultFunc<T> implements Function<T, T> {
