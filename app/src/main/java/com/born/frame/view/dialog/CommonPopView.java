...
public class CommonPopView extends PopupWindow {
    ...
    public static class Builder {
        ...
        private ICallBackPopView mHandler = null;
         ...
         * @param clazz    页面对应的ViewHolder
         * @param handle   回调回去自己处理
         */
        public Builder(Context context, int layoutId, Class clazz, ICallBackPopView handle) {
        ...
        public CommonPopView create() {
            ...
            Object holder = null;
            try {
                holder = mClazz.getConstructor(View.class).newInstance(view);
            } catch (Exception e) {
                e.printStackTrace();
            }
            mHandler.handlePopView(popupWindow, holder, mAdapter);
    ...
    public interface ICallBackPopView {
         ...
         * 处理PopupWindow的页面
         */
        public void handlePopView(CommonPopView popView, Object holder, Object adapter);
    }
}
