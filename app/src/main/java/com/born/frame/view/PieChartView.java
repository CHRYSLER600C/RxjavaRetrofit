...
public class PieChartView extends View {
	...
	/** 顶部空间距离 */
	private float TOP_PADDING = 25 * density;
	/** 饼图和下边文字的距离 */
	...
	private int[] mColors = new int[] { 0xfff5a002, 0xfffb5a2f, 0xff36bc99, 0xff43F90C, 0xff181A18, 0xffF802F6,
			0xff022DF8, 0xffECF802, 0xff02F8E8, 0xffEA0F8E, 0xffFF0000, 0xffADFF2F, 0xffB23AEE, 0xff8B3E2F, 0xff87CEFA,
			0xff636363, 0xff0D0D0D, 0xff006400,  };
	/** 值 */
	...
	protected void onDraw(Canvas canvas) {
		...
		float r2 = 0;
		if (mIsShowText) {
			r1 = getWidth() - LR_PADDING * 2;
			r2 = getHeight() - TOP_PADDING - PIE_TEXT_DIS - (TEXT_TEXT_DIS + textHeight) * (mTitles.length)
					- BOTTOM_DIS;
	...
	public void setShowText(boolean mIsShowText) {
	...
	private void setPieContentText(Canvas canvas) {
		...
		for (int i = 0; i < centerAngle.length; i++) {
			...
			canvas.drawText(perMsg, cenX - getTextWidth(perMsg, mPieTextSize) * 1.0f / 2,
					cenY + getTextHeight(perMsg, mPieTextSize) * 1.0f / 2 / 2, mTextPaint);
			lastPir -= curPer;
		}
	}
