...
public abstract class PullBaseView<T extends RecyclerView> extends LinearLayout {
    ...
    private boolean isFooterHide = false;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        addHeaderView();
        LinearLayout view = createRecyclerView(context, attrs);
        mRecyclerView = (T) view.getChildAt(1);
    ...
    private void addHeaderView() {
        // header view
        mHeaderView = mInflater.inflate(R.layout.pullrecyclerview_header, this, false);
    ...
    private void addFooterView() {
        // footer view
        mFooterView = mInflater.inflate(R.layout.pullrecyclerview_footer, this, false);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mPullState == PULL_DOWN_STATE) {
                    ...
                    if (isFooterHide) footerPrepareToRefresh(deltaY);
                }
                mLastMotionY = y;
                break;
            case MotionEvent.ACTION_UP:
    ...
    private boolean isRefreshViewScroll(int deltaY) {
        ...
        if (mRecyclerView != null) {
            ...
            if (deltaY > 0) {
                ...
                if (isScrollTop() && Math.abs(top - padding) <= 20) {// 这里之前用3可以判断,但现在不行,还没找到原因
                    mPullState = PULL_DOWN_STATE;
                    return true;
                }
            } else if (deltaY < 0) {
...
//        }
    ...
    protected abstract LinearLayout createRecyclerView(Context context, AttributeSet attrs);
